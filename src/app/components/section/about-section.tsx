...
export function AboutSection() {
  return (
    <section
      ...
      className="w-screen max-w-full pb-12 pt-4 sm:pb-16 sm:pt-6"
    >
      <div
        className={`${pageContentShellClassName} text-left`}
      >
        <SectionHeading id="about-heading" className="mb-7 text-left sm:mb-8">
          About
        </SectionHeading>
        <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:gap-12 xl:gap-14">
          <div
          ...
          >
            ...
            <p className="mt-7 text-base text-muted-foreground/80 sm:mt-8 sm:text-lg">
              — Silver
            </p>
          </div>
          <div className="relative mx-auto w-full max-w-md shrink-0 lg:mx-0 lg:max-w-none lg:justify-self-end">
            <Image
              src="/about.png"
              alt="About section illustration"
              width={1359}
              height={1158}
              sizes="(min-width: 1024px) min(50vw, 680px), min(100vw - 2rem, 28rem)"
              className="h-auto w-full rounded-lg object-contain object-right"
            />
          </div>
        </div>
      </div>
