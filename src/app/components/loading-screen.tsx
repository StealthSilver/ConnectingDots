...
function ConnectingDotsIndicator() {
  return (
    <div aria-hidden className="relative flex h-3 items-center gap-2.5">
      <span className="absolute inset-x-1.5 top-1/2 h-px -translate-y-1/2 bg-[color:var(--color-line)]" />
      {[0, 1, 2].map((i) => (
        <span
          key={i}
